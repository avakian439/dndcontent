---
type: NPC
name: Elara 'Ironheart' Vancroft
status: Alive
race: Human
gender: Female
occupation: Adventurer's Guild Liaison / Veteran Adventurer
...
> [!infobox|bg-c-brown]+
> `VIEW[{name}]`
> ![[ddGraveRobber.webp|cover hsmall]]
> 
> |  |  |
> | ---- | ---- |
> | Status | `VIEW[{status}]` |
...
> | Age | `VIEW[{age}]` |
> | Related to: | [[Kaelen 'Ironhand' Stonefist]] |
...
*   **Brief origin story or significant past event:** Elara earned her "Ironheart" moniker during a legendary defense of a besieged outpost, where her unwavering resolve inspired a ragtag group to hold the line against impossible odds. She and [[Kaelen 'Ironhand' Stonefist]] were once formidable adventuring partners, their names often spoken in the same breath across the taverns of Outer Heaven. While Kaelen retired to run [[The Cloud's Edge]], Elara chose to continue serving the adventuring community in a more administrative, yet still active, capacity.
*   **How others generally perceive them:** A respected veteran, a fair but firm hand within the Adventurer's Guild, and a reliable source of information and guidance. Many younger adventurers look up to her, while older ones remember her legendary exploits.

#### Goals & Motivations:
*   **What they want most:** To ensure the safety and prosperity of Outer Heaven's adventuring community, and to maintain the delicate balance of power within the city.
*   **What drives them:** A deep-seated sense of duty, a desire to prevent the mistakes of the past, and a quiet hope that the next generation of heroes will be even greater.
...
*   **A secret they keep or a potential way for players to get involved:** Elara carries the burden of a past decision that led to the loss of a close friend during a planar expedition years ago, a secret she shares only with Kaelen. She might approach the players directly, impressed by their reputation, to undertake a critical mission related to the planar rifts, or to investigate a suspicious activity that threatens the Guild's operations.